...
<div class="container">
    <?php dsgov_breadcrumb_redes(); ?>
</div>


<div class="slider-govbr" id="featured" data-listbox-title="<?php echo __('Featured'); ?>" data-play-speed="<?php echo ($playSpeed) ? $playSpeed : '5000'; ?>">
...
<div class="slider-govbr d-flex align-items-center" id="intro">
    <h1 class="dsgov-omeka-title"><?php echo get_theme_option('homepage_text'); ?></h1>
</div>
<?php endif; ?>
