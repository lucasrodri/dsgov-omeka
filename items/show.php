...
<div class="dsgov-omeka-items-show-breadcrumb">
<?php
$link_items=html_escape(WEB_ROOT) . tag_attributes(array()) . "/items";
dsgov_breadcrumb_redes(array(['name' => __('Items'), 'type' => 'link', 'link' => $link_items],['name' => $title, 'type' => 'page'])); 
?>
</div>

<div class="flex dsgov-omeka-items-show">
